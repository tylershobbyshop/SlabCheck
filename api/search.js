...
function fetchEbaySold(query) {
  return new Promise((resolve, reject) => {
    ...
    const path = `/services/search/FindingService/v1?OPERATION-NAME=findCompletedItems&SERVICE-VERSION=1.13.0&SECURITY-APPNAME=${EBAY_APP_ID}&RESPONSE-DATA-FORMAT=JSON&itemFilter%280%29.name=SoldItemsOnly&itemFilter%280%29.value=true&keywords=${encodedQuery}&paginationInput.entriesPerPage=50&sortOrder=EndTimeSoonest`;
